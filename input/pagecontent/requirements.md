...
* If it does, it SHALL report so in TerminologyCapabilities.expansion.parameter.name (this parameter makes a big difference to performance for clients - reduces network utilization very much)
